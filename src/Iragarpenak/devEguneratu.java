...
public class devEguneratu {
    ...
    private static void validateArguments(String[] args) {
        if (args.length != 4) {
            System.err.println("Uso: java ModificarArff <train.arff> <dev.arff> <output.arff> <num_predictors>");
            System.err.println("Ejemplo: java ModificarArff train.arff dev.arff dev_normalized.arff 500");
            System.exit(1);
        }
    }
    ...
    private static Instances normalizeStructure(Instances devData, Instances trainData, int predictorsCount, int requiredAttributes) throws Exception {
        ...
        // Añadir todos los atributos de trainData en el mismo orden
